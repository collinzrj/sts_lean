...
theorem ComboStormOfSteel_L2_verified :
    GuaranteedInfiniteCombo cardDB
      ComboStormOfSteel_L2.cards
      ComboStormOfSteel_L2.enemy :=
  ComboStormOfSteel_L2.proof

-- Axiom auditing: must not depend on sorry or custom axioms
-- Expected output: only propext, Classical.choice, Quot.sound
#print axioms ComboStormOfSteel_L2_verified
