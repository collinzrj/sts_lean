...
def setupTrace : List Action := [
  ...
  .play 0,                -- Prepared+#1: draw 2, discard 2 -> inUse
  ...
  .discard 3,             -- discard Reflex+(3) -> triggers draw 3 (bottom)
  .draw 3,                -- shuffle [RP2(3),RP1(2)]->draw, draw RP2(3)
  .draw 2,                -- draw RP1(2)
  .failDraw               -- skip remaining draws. P1(0)->discard via resolveInUse.
]
...
def loopTrace : List Action := [
  ...
  .draw 4, .draw 0,       -- shuffle discard [N(4),P1(0)]->draw, draw N(4), P1(0)
  .discard 2,             -- discard Reflex+(2) -> triggers draw 3 (bottom)
  .discard 3,             -- discard Reflex+(3) -> triggers draw 3 (bottom)
  .draw 3,                -- shuffle [RP2(3),RP1(2)]->draw, draw RP2(3)
  .draw 2,                -- draw RP1(2)
